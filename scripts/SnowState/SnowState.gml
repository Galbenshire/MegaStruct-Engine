...
/// @func SnowState(initial_state, [execute_enter], [owner])
...
/// @param {instance}   [owner]		The owner of this state machine [Default: the instance calling this constructor]
function SnowState(_initState, _execEnter = true, _owner = other) constructor {
